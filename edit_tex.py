...
all_task_settings = {
    ...
    "polish": {
        ...
        "output_type": "tex",
        # "first_prefill": "Here is the improved latex document. <updated_latex_document>",
        "first_prefill": "<scratchpad>",
        # "system_prompt_file": "system_prompt_polish_cirac.txt",
        "system_prompt_file": "system_prompt_polish_welling.txt",
        # "user_prefix_file": "user_prefix_polish.txt",
        "user_prefix_file": "user_prefix_polish_welling.txt",

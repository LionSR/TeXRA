# TeXRA Sample Project

Welcome! This workspace pairs with the **Run your first TeXRA workflow** walkthrough.
Follow the checklist below to see the extension in action:

1. [Open the walkthrough](command:texra.openGettingStarted) if you closed it earlier.

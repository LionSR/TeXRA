...
export interface PendingApproval {
  ...
  /**
   * Answer this request. The runtime is a parameter because this surface is
   * a process-wide signal, not a per-session object: the component that
   * answers holds the chat entry point's runtime and hands it over here.
   */

...
const SCENARIOS = [
  ...
  },
  {
    ...
    expect: [
      ...
      '/login',
      'Sign in to ChatGPT or Researcher',
      '… 12 more',
    ],
    unexpect: [
      '/ap  Switch',
  ...
  },
  {
    ...
    expect: [
      ...
      '/auth',
      'Show both accounts and active model access',
      '/login',
  ...
  },
  {
    ...
    expect: [
      ...
      'y approve',
      'n reject',
      'a agent work in this chat',
      'Approves this task and later tasks from this agent',
      'plus file edits and',
      'commands. Other prompts still ask',
    ],

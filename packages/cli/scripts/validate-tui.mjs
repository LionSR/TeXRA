...
const SCENARIOS = [
  ...
  },
  {
    ...
    expect: [
      ...
      'n reject',
      'a all agent work',
      'y approves this task only. a also approves later tasks',
      'file edits and commands for this chat',
  ...
  },
  {
    ...
    expect: [
      ...
      'a all agent work',
      'Esc reject',
      'y approves this task only',
      'from this agent, plus file edits and commands for this',
      'chat. Other prompts still ask',
    ],
    maxLineColumns: 60,
  },
  {
    ...
    expect: [
      ...
      'Esc reject',
      'y approves this task only',
      'a also approves later tasks from this agent',
      'commands for this chat. Other prompts still ask',
    ],
    maxLineColumns: 100,
  },
  {

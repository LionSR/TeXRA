/**
 * The desktop host's run edge for app-signal subscriptions (PRD R1: the fork
 * lives at the host entry, not in the bus). Mirrors
 * `desktopGoalSubscription`: one fiber draining the signal's `PubSub`

...
def main():
    ...
    parser.add_argument("--agent", type=str, default="correct_prl", help="Mode of operation, 'correct_prl' for both main and supplementary materials.")
    ...
    edit_prl = EditPRL(args, agent_path)
    edit_prl.run()

...
`agents/docs/archived/process/2026-07-29-open-source-readiness.md`, which covers licensing,
...
- **Trademark and branding.** `installTexraBackend` and `src/controllers/texra/`
  ...
  `agents/docs/archived/process/2026-07-29-open-source-readiness.md` §1.4 lands on.

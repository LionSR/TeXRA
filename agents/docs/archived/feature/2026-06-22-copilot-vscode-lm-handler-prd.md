...
**Companion proposal:** [`2026-06-22-copilot-oauth-handler-prd.md`](../../rejected/feature/2026-06-22-copilot-oauth-handler-prd.md) (the cross-host OAuth route — experimental/parked)
...
- It is the **only official** way to reach the user's Copilot subscription — no
  ...
  [OAuth route](../../rejected/feature/2026-06-22-copilot-oauth-handler-prd.md)).

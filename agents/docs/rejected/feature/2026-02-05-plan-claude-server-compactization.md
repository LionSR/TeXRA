...
> **PRD Decision:** The main PRD (`agents/docs/archived/feature/2026-02-02-prd-context-compactization.md`, Section 4.6) explicitly chose **client-side summarization** over server-side compaction for Anthropic. Reasons cited:
>
...
>
> This plan is preserved as a **reference and future option**, not a recommended near-term approach. Implement `agents/docs/archived/feature/2026-02-05-plan-claude-client-compactization.md` first.

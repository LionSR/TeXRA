...
(`prds/dual-logic-features.md`, `prds/dual-logic-infrastructure.md`,
`prds/dual-logic-audit-2026-02.md`), which already shipped the small shared
...
- `prds/dual-logic-audit-2026-02.md`
- `prds/dual-logic-features.md`
- `prds/dual-logic-infrastructure.md`

...
async function testStreamingWithAggregation() {
  try {
    ...
    console.log('Content matches:', aggregatedText.trim() === nonStreamText.trim());
    console.log('Both have stop_reason:', 
...
async function testStreamToFinalMessage() {
  ...
  try {
    ...
    console.log('\n\nFinal message from finalMessage():', JSON.stringify(finalMessage, null, 2));
...
async function testStreamWithIteratorAndFinal() {
  ...
  try {
    ...
    console.log('Test 1: Beta stream with async iteration then finalMessage()\n');
    ...
    console.log('\n\nFinal message after iteration:', JSON.stringify(finalMessage1, null, 2));
...
async function testStreamWithBetaAPI() {
  ...
  try {
    ...
    console.log('\n\nFinal message from beta.messages.stream():', JSON.stringify(finalMessage, null, 2));

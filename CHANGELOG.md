...
- Return PDFs from the `read_file` tool as native attachments with guidance for models that cannot display binary results, preventing corrupted text output.

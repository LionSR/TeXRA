...
- **Delegation prompts can approve the rest of the session** — press `a` to
...
- **Delegated-task approval uses a clear name** — proposal menus now describe
  the session-wide action directly instead of calling it “Super Yolo.”

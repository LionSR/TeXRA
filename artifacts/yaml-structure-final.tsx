...
import { FileText, Settings, Braces, Files, ArrowRight, Box, Terminal, MessageSquare, ArrowDown, FileCode } from 'lucide-react';
...
const FileMapping = ({ title, example }) => (
  <div className="mb-4">
    ...
    <ExampleBlock title="Raw File">
      {example.raw}
    </ExampleBlock>
    <div className="flex items-center justify-center my-2">
      <ArrowDown className="w-4 h-4 text-gray-400" />
    </div>
    <ExampleBlock title="XML Wrapped">
      {example.wrapped}
    </ExampleBlock>
  </div>
);
      ...
      <PromptFlowBox
        ...
        content={
          <div className="bg-blue-50 p-2 rounded">
            ...
            <div className="text-xs italic mt-1">e.g., LaTeX formatting rules</div>
          </div>
        }
      />
      <PromptFlowBox
        ...
        content={
          <div className="bg-green-50 p-2 rounded">
            ...
            <div className="text-xs italic mt-1">e.g., XML document wrapping</div>
          </div>
        }
      />
      <PromptFlowBox
        ...
        content={
          <div className="bg-yellow-50 p-2 rounded">
            ...
            <div className="text-xs italic mt-1">e.g., Revision instructions</div>
          </div>
        }
      />
    </div>
      ...
      <PromptFlowBox
        ...
        content={
          <div className="bg-orange-50 p-2 rounded">
            ...
            <div className="text-xs italic mt-1">e.g., &lt;latex_document&gt;</div>
          </div>
        }
      />
    </div>
    ...
    <div className="max-w-5xl mx-auto p-6 bg-gray-50">
      ...
      <YamlSection>
        ...
        <div className="mt-4">
          ...
          <FileInput name="input_file/input_files" description="Main content file(s)" />
          <FileInput name="reference_file/reference_files" description="Reference materials" />
          <FileInput name="auxiliary_file/auxiliary_files" description="Support files" />
        </div>
      </YamlSection>
          ...
          <div>
            <FileMapping 
              ...
              example={{
                ...
                wrapped: '<document name="commands.tex">\n  \\newcommand{\\op}{\\hat{O}}\n</document>'
              }}
            />
          </div>
          ...
          <div>
            <FileMapping 
              ...
              example={{
                ...
                wrapped: '<document name="paper.tex">\n  \\documentclass{article}\n  % Main paper content\n</document>'
              }}
            />
          </div>
        </div>

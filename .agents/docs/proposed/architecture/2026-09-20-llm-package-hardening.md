...
Re-derived against `main` at `068c5f5d33`. Four of the five changes below are
...
| Gap                                             | Evidence                                                                                                                                                                                                                                                                                                                                                                                    |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Hosted tools regressed                          | OpenAI web search and Anthropic search and fetch worked on the deleted handlers; the codecs fail explicitly (`anthropicMessages.ts:680`, "Anthropic hosted-tool accounting is not supported by this codec", beside the unsettled-content arm at `:708`). The 2026-09-07 comparison required closing this before retiring the routes. It is the one change left, and it is an owner decision |

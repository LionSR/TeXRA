...
| [Effect facility adoption](../simplification/2026-09-20-effect-facility-adoption.md)                   | simplification | the duplicated read logic in three config providers (the writable providers and their synchronous `get` stay), the second logger, two backoff copies, an `EventEmitter`                                                                                                                                  | #12886                                                           |

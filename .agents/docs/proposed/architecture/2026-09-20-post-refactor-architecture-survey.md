...
- a set of second copies of run state that can disagree with the rows
  (section 2, [single-owner liveness](../../implemented/architecture/2026-09-20-single-owner-liveness-and-one-fold.md));
...
- product logic written two or three times across the hosts
  ([host layer](../../archived/simplification/2026-09-20-host-layer-collapse.md));
- a schema barrel and a tool-call path carrying more than they need
  ([tools and schemas](../../archived/simplification/2026-09-20-tools-and-schema-surface-collapse.md));
...
liveness, one of which also sits in the fencing bucket. That is 13 distinct
commits of 18 that are impossible under strict single-owner-per-fact.
...
| --------------------------------------------------------------------------------------------------------------------- | -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| [Single-owner liveness and one fold](../../implemented/architecture/2026-09-20-single-owner-liveness-and-one-fold.md) | architecture   | `runLanes.ts`, `waitingTermination.ts`, `holdLive`, the snapshot cross-checks, `StreamLogStore` as a store                                                                                                                                                                                                           | #12881                                                           |
| [Run-program and dispatch dedup](../simplification/2026-09-20-run-program-and-dispatch-dedup.md)                      | simplification | seven duplicated loop pairs, a shared attempt schema, two envelope formatters, one abort bridge, two empty path segments                                                                                                                                                                                             | #12882                                                           |
...
| [Host-layer collapse](../../archived/simplification/2026-09-20-host-layer-collapse.md)                                | simplification | a duplicated 42-arm switch, two Supabase state machines, two settings registries, two bootstrap bodies                                                                                                                                                                                                               | #12884                                                           |
| [Tools and schema-surface collapse](../../archived/simplification/2026-09-20-tools-and-schema-surface-collapse.md)    | simplification | the non-contract half of the barrel closure, four probe catalogs, eight row arms, two pass-through tool layers                                                                                                                                                                                                       | #12885                                                           |
| [Effect facility adoption](../../implemented/simplification/2026-09-20-effect-facility-adoption.md)                   | simplification | three config providers, the second logger, two backoff copies, an `EventEmitter`                                                                                                                                                                                                                                     | #12886                                                           |
...
| [Service scopes and ownership ledger](../../archived/simplification/2026-09-20-service-scope-ownership-ledger.md)     | simplification | the `Requests` tag, `ToolInjections` threading, the launch unwind stack, five `ToolCall` fields, `withScopedDatabase` (see [its note](../../archived/simplification/2026-09-20-global-database-process-service.md)), the usage-log singleton, the `AppState` cast, the SDK `Runtime` tag; eight refutations recorded | consolidated into #12425, #12882, #12884, #12422, #12076, #12071 |
...
The [host-collapse update](../../archived/simplification/2026-09-20-host-layer-collapse.md#dispatcher-decision-update--2026-09-22)

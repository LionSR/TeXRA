...
| Fact                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Consequence                                                                                                                                                                                    |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 510 files import `effect` (was 526); 467 `Effect.fn`, 350 `Effect.gen`, 243 `Stream.`, 149 `Deferred.`, 142 `Scope`/`Effect.scoped` (non-test); 18 `Context.Service` tags in 14 files; **two** `ManagedRuntime.make` (`sessionLayer.ts:769`, `webviewSessionLayer.ts:80`, one per host root); one `LayerMap.make` (`sessionLayer.ts:525`); **one** `Semaphore.make` (`memoryFileSystem.ts:302`) plus 14 `makeUnsafe`. `PubSub`, `Context.Reference`: zero.                                                        | The idiom is established. What is missing is the runtime's own program tree and the layers that compose it.                                                                                    |
...
| `forkDetach` count and `Semaphore.makeUnsafe` count (rev 4 review)               | yes     | §1, §2                                                |

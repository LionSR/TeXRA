...
**Owner:** TBD
**Date:** 2026-05-10
**Companions:** [`2026-05-04-prd-cli-app.md`](../feature/2026-05-04-prd-cli-app.md), [`2026-05-06-prd-runcontext-refactor.md`](./2026-05-06-prd-runcontext-refactor.md), [`2026-05-06-prd-logger-v2.md`](./2026-05-06-prd-logger-v2.md)
...
A compact orchestration manifest lives at `.agents/docs/archived/architecture/2026-05-10-prd-cli-runcontext-logger-orchestration.manifest.json`. It maps each issue to its PRD, source of truth, and acceptance gates. Loop agents should use the manifest as an index, not as a replacement for the PRD text.

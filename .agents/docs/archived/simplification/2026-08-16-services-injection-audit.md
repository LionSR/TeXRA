...
The seams census found 8 seams/families of the "one production impl; seam exists for tests" species that the shared-contracts Tier-3 list (`.agents/docs/archived/simplification/2026-08-15-shared-contracts-and-retirement.md:349-357`, 6 symbols) missed:

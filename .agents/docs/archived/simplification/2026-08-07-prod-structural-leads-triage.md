...
- **Two progressView PRDs still reference the deleted ProviderErrorSchema name**
  evidence: .agents/docs/archived/simplification/2026-01-24-prd-progressview-phase1.md:30 and 2026-01-24-prd-progressview-modernization.md:314 mention ProviderErrorSchema; zero code references repo-wide

...
| The run program and workflow round mode    | [one run program](./implemented/architecture/2026-09-24-one-run-program.md)                                                                                                                                       |
...
| Session database off the host thread       | [session database off the host thread](./proposed/architecture/2026-09-26-session-database-off-host-thread.md)                                                                                                    |
...
| Workflow scripts (`delegate_multi_agents`) | [workflow script generator protocol](./implemented/architecture/2026-09-25-workflow-script-generator-protocol.md)                                                                                                 |
...
| Standing SDK-readiness re-verification     | [2026-09-26 re-verification](./proposed/architecture/2026-09-26-agent-sdk-readiness-reverify.md)                                                                                                                  |
...
| Which Effect facility replaces what        | [effect facility adoption](./implemented/simplification/2026-09-20-effect-facility-adoption.md)                                                                                                                   |
| Test estate, tiers and the registry        | [shared module registry](./proposed/testing/2026-09-10-shared-module-registry.md)                                                                                                                                 |
| Desktop and extension UX: order of work    | [UX principles and work order](./proposed/feature/2026-09-26-desktop-and-extension-ux-roadmap.md)                                                                                                                 |

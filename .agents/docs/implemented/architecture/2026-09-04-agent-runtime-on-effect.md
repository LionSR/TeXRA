...
[migration PRD](../../archived/architecture/2026-08-26-effect-4-runtime-migration.md). The
...
[review](../../archived/architecture/2026-09-06-agent-architecture-review.md) add a necessary dependency:
...
1. Foundation: `RunLedger` service over `SessionEvents`, the Zod row
   ...
   [PR 1 foundation proposal](../../archived/architecture/2026-09-08-pr1-run-ledger-foundation.md#28-the-arms-in-sessioneventts),

...
Status: rejected — superseded by the AgentTrace consolidation

> **Status:** Superseded (2026-07-04 refresh) by the AgentTrace consolidation
> (see [`2026-05-22-agent-trace-sdk-surface.md`](../../archived/architecture/2026-05-22-agent-trace-sdk-surface.md)):
...
> [`2026-06-10-error-pipeline-and-ownership.md`](../../implemented/architecture/2026-06-10-error-pipeline-and-ownership.md).
> **Date:** 2026-05-17

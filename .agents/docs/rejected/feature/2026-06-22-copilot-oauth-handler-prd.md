...
Status: rejected — parked pending a ToS-risk decision
...
**Companion proposal:** [`2026-06-22-copilot-vscode-lm-handler-prd.md`](../../archived/feature/2026-06-22-copilot-vscode-lm-handler-prd.md) (the official, VS Code-only route)
**Closest existing precedent in this repo:** [`2026-06-21-chatgpt-subscription-codex-auth.md`](../../archived/feature/2026-06-21-chatgpt-subscription-codex-auth.md) — structurally near-identical (borrowed client id, unofficial endpoint, OpenAI-shaped backend).
...
[`vscode.lm` route](../../archived/feature/2026-06-22-copilot-vscode-lm-handler-prd.md), this works in the CLI and
...
- In-repo precedent: [`2026-06-21-chatgpt-subscription-codex-auth.md`](../../archived/feature/2026-06-21-chatgpt-subscription-codex-auth.md)

...
const evidence = path.join(
  repo,
  '.agents/docs/evidence/2026-09-06-agent-architecture',
);
...
const docs = [
  ...
  '.agents/docs/archived/architecture/2026-09-06-agent-architecture-review.md',
  '.agents/docs/archived/architecture/2026-09-06-agent-loop-architecture-study.md',
  '.agents/docs/implemented/architecture/2026-09-06-llm-package-architecture-study.md',

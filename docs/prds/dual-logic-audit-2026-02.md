...
- `docs/prds/prd-dual-logic-audit-2026-02.md` (deleted)
- `docs/prds/dual-logic-impact-audit.md` (deleted)
- `docs/prd-dual-logic-audit-2026-02.md` (deleted)

Related completed PRDs (kept for reference):

- `docs/prds/dual-logic-features.md` — ✅ Complete
- `docs/prds/dual-logic-infrastructure.md` — ✅ Complete

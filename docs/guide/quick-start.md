...
This guide will help you get up and running with CoAuthor quickly. In just a few minutes, you'll be able to use AI to enhance your academic writing in VS Code.

## Overview

CoAuthor integrates powerful AI capabilities directly into your writing workflow. Here's what you can do:
...
The typical CoAuthor workflow consists of these steps:
...
1. Open VS Code
2. Navigate to the CoAuthor panel in the sidebar (click the quantum deer icon)
...
1. In the CoAuthor panel, click the "Current" button next to "Input" to set your active document as the input file
...
3. You can compare the original and modified versions using:
   ...
   - CoAuthor's LaTeXdiff feature in the CoAuthor panel

<!-- ![Results Review](/images/results-review.png) -->

## Common Quick Tasks

Here are some common tasks you can try with CoAuthor:
...
When CoAuthor completes a task, it produces:
...
Now that you've completed your first task with CoAuthor, you can:

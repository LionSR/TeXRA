...
CoAuthor provides advanced capabilities for working with TikZ figures in LaTeX documents. These features help you create, extract, modify, and manage technical diagrams with AI assistance.
...
CoAuthor's `draw` agent is specifically designed to work with TikZ figures. It can:
...
CoAuthor can automatically extract TikZ figures from your LaTeX documents for separate processing and management.
...
When automatic extraction is enabled, CoAuthor will:
...
3. Run "CoAuthor: Extract TikZ Figures from Current File"
...
When using the automatic extraction feature, CoAuthor will:
...
2. Run "CoAuthor: Compile TikZ Figures from Current File"

This will compile all extracted figures and generate preview images.

## Customizing TikZ Processing

You can customize how CoAuthor handles TikZ figures through several settings:
...
By default, CoAuthor includes your workspace root in the TEXINPUTS environment variable:
...
CoAuthor's `draw` agent can implement advanced TikZ techniques:
...
Now that you understand how to work with TikZ figures in CoAuthor, you might want to explore:

- [LaTeX Diff](/guide/latex-diff) - Learn how to compare document versions including figures
- [Tool Integration](/guide/tool-integration) - Discover other tools CoAuthor integrates with
- [Best Practices](/reference/best-practices) - Learn general best practices for working with CoAuthor

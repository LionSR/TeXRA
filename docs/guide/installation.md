...
Node.js 22.19.0 or later in 22.x, or Node.js 24 or later):
...
<p class="hero-caption">The Settings Models page → API keys: each provider shows its key status (Set · Env · Not set) with Set, Get, and Remove actions.</p>

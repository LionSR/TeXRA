...
As the project evolves, a preferred citation format (for example, a white paper or software citation) will be published. Check the [TeXRA GitHub repository](https://github.com/LionSR/TeXRA) or the [texra.ai](https://texra.ai) website for citation details.

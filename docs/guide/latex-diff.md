...
<div class="pdf-examples">
  <div class="pdf-tabs">
    <a href="#" class="pdf-tab active" onclick="switchPdf('/examples/draft_polish_r0_gemini25p_diff.pdf', this); return false">Round 0: Initial AI Edit</a>
    <a href="#" class="pdf-tab" onclick="switchPdf('/examples/draft_polish_r1_gemini25p_diff.pdf', this); return false">Round 1: After Reflection</a>
    <a href="#" class="pdf-tab" onclick="switchPdf('/examples/draft_polish_r1_gemini25p_diffr1r0.pdf', this); return false">Reflection Changes</a>
  </div>
...
<script>
function switchPdf(pdfPath, tab) {
  // Update iframe source
  document.getElementById('pdf-frame').src = pdfPath;
  // Update "Open in new tab" link
  document.getElementById('pdf-link').href = pdfPath;
  
  // Update active tab
  var tabs = document.getElementsByClassName('pdf-tab');

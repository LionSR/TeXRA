...
Below are embedded examples of diff PDFs generated from `/examples/draft.tex` using the `polish` agent and `gemini25p` model. You can scroll through them to see how `latexdiff` visualizes changes:

**Original vs. Round 0 Output (`draft_polish_r0_gemini25p_diff.pdf`)**

This shows the initial changes proposed by the agent before reflection.

<iframe src="/examples/draft_polish_r0_gemini25p_diff.pdf" width="100%" height="500px" style="border: 1px solid #ccc;"></iframe>

**Original vs. Round 1 Output (`draft_polish_r1_gemini25p_diff.pdf`)**

This shows the final changes after the agent reflected and refined its output.

<iframe src="/examples/draft_polish_r1_gemini25p_diff.pdf" width="100%" height="500px" style="border: 1px solid #ccc;"></iframe>

**Round 0 vs. Round 1 Output (`draft_polish_r1_gemini25p_diffr1r0.pdf`)**

This compares the agent's initial output (Round 0) with its refined output (Round 1), highlighting the changes made during the reflection step.

<iframe src="/examples/draft_polish_r1_gemini25p_diffr1r0.pdf" width="100%" height="500px" style="border: 1px solid #ccc;"></iframe>

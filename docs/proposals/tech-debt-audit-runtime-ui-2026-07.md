...
> [`fewer-elements-2026-07.md`](./fewer-elements-2026-07.md),
> [`agent-runtime-ui-coupling-audit.md`](./agent-runtime-ui-coupling-audit.md),
...
(`session-scoped-runtime-architecture.md` ~248-253) already prescribes the collapse.
...
(`session-scoped-runtime-architecture.md:266-269`).
...
code comments + docs (`session-scoped-runtime-architecture.md`: "Deleted; display

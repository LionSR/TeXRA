...
[`-2026-07-06`](./agent-sdk-readiness-checkpoint-2026-07-06.md)).
...
reviewed PR train has since *resolved* two of the top items the standing audit
...
3. **`TextConnectionService` is a single-member, single-extender exported
   ...
   (`textConnection.ts`). The port *member* is needed (core can't import

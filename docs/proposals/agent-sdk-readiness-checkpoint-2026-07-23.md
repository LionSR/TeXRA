...
[`-2026-07-22`](./agent-sdk-readiness-checkpoint-2026-07-22.md)).
...
2. **The real core/runtime SDK-readiness item is ambient/global coupling, not
   ...
   `agent-sdk-readiness-audit.md`, the `-07-18` checkpoint, and
   `agent-sdk-readiness.md` all record the ambient-`RunContext` / backward-edge
...
7. **Trace `AgentEvent` union imports TeXRA-specific payloads directly**
   ...
   [`agent-trace-sdk-surface.md`](./agent-trace-sdk-surface.md)**, which

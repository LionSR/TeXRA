...
time. Companion docs: `tech-debt-audit-2026-07.md` (A2 named this seam "the
single largest source of 'works in extension, broken in desktop' bugs"),
`tech-debt-audit-runtime-ui-2026-07.md` (A2/A16/A17, rejected trap R4),
`tech-debt-error-ownership-2026-07.md` (EP-R2/EP-4, UICPL-04),
`session-scoped-runtime-architecture.md` (plane-2 pending-registry target,
...
- **Convergence:** desktop half is tracked-decided-unbuilt: **UICPL-04**
  (`tech-debt-error-ownership-2026-07.md:50`, ~0 LoC, rejected traps stand).
...
- **DR2. Prompt replay after view reload.** Extension replays 6 kinds but
  **not userQuestion** (`ProgressViewProvider.ts:468-482`; worse — a
  ...
  the plane-2 target (`session-scoped-runtime-architecture.md:260-262`).
...
17. Desktop ships no retry panel and declines synchronously — EP-R2
    (`tech-debt-error-ownership-2026-07.md:16`); retry transport stub kept per

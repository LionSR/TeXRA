...
[`2026-05-22-agent-trace-sdk-surface.md`](./2026-05-22-agent-trace-sdk-surface.md), and the
...
7. **[strategic] Trace `AgentEvent` union imports TeXRA-specific payloads
   ...
   [`2026-05-22-agent-trace-sdk-surface.md`](./2026-05-22-agent-trace-sdk-surface.md)**, which

...
These probes support the [September 5, 2026 view-replication evaluation](../../2026-09-05-event-fold-versus-view-replication-evaluation.md).
...
node docs/proposals/evidence/2026-09-05-view-replication/texra-fold-build.mjs \
...
node --version
node --expose-gc \
  docs/proposals/evidence/2026-09-05-view-replication/chord-replica-probe.mjs \
  "$PI_SOURCE_ROOT" > "$PI_PROBE_DIR/chord-replica-probe.fresh.out"
node --expose-gc \
  docs/proposals/evidence/2026-09-05-view-replication/chord-active-shape-probe.mjs \

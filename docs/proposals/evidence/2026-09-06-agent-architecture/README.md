...
The [HTML explorer](../../2026-09-06-agent-architecture.html), [decision study](../../2026-09-06-agent-architecture-study.md), [loop study](../../2026-09-06-agent-loop-architecture-study.md), [LLM package study](../../2026-09-06-llm-package-architecture-study.md), and [architectural review](../../2026-09-06-agent-architecture-review.md) are recommendations, not production changes. The review identifies four unresolved contract gaps and makes preservation of the reflection pipeline explicit.
...
```sh
node docs/proposals/evidence/2026-09-06-agent-architecture/source-census.mjs \
  /absolute/path/to/pinned-texra-source \
  /absolute/path/to/installed-texra \
  docs/proposals/evidence/2026-09-06-agent-architecture/source-census.json
```
...
```sh
node docs/proposals/evidence/2026-09-06-agent-architecture/effect-ai-boundary-probe.mjs \
  /absolute/path/to/installed-texra
```
...
npx --yes --package @mermaid-js/mermaid-cli@11.17.0 mmdc \
  -i docs/proposals/evidence/2026-09-06-agent-architecture/ownership.mmd \
...
```sh
node docs/proposals/evidence/2026-09-06-agent-architecture/check-study-links.mjs \

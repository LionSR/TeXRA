...
**Status:** Audit (2026-05-30; re-verified 2026-05-31). **Steps 1–3 + 5 + 6 landed** (Step 4 folded into Step 5; Step 6 landed in PR #4781 / commit `da131dc`); Step 7 (a–d) pending. See the 2026-05-31 addendum in [`../agent-sdk-readiness-audit.md`](../agent-sdk-readiness-audit.md) §9.

...
- Same diff renderer used in the edit-approval modal ([04-approval-edit.md](./04-approval-edit.md)).
...
| Task / Agent-spawn                   | Rich badge      | Status is "spawned subagent X" — see [02-multi-agent.md](./02-multi-agent.md). |

...
| `Ctrl-Y`            | Yolo-for-turn (auto-approve subsequent bash calls in the current turn). **Only inside an open bash-approval modal** — see [mockups/03-approval-bash.md](./mockups/03-approval-bash.md).                                                                        |
...
| `Esc`               | Close modal / palette / cancel inline edit; otherwise interrupt the active run when one is pending                                                                                                                                                             |
| `?`                 | Inline help overlay                                                                                                                                                                                                                                            |
...
- **R11.** No mouse text selection. Out of scope per [00-overview § Non-goals](./00-overview.md#4-non-goals-explicitly-excluded).

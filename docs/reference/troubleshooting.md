...
This guide helps you diagnose and resolve common issues you might encounter when using CoAuthor. We've organized troubleshooting tips by category to help you quickly find solutions to specific problems.

## Installation Issues

### Extension Not Loading

**Problem**: CoAuthor doesn't appear in the sidebar or shows errors during load.
...
4. **Check extension conflicts**:
   ...
   - Restart VS Code and check if CoAuthor works
...
**Problem**: Problems with selecting or managing files in CoAuthor.
...
**Problem**: CoAuthor operations take too long to complete.
...
**Problem**: Issues with CoAuthor's integration with VS Code features.
...
If you've resolved your issue or want to learn more about CoAuthor:

- [Best Practices](/reference/best-practices) - Learn how to use CoAuthor effectively
- [Configuration](/guide/configuration) - Customize CoAuthor for your needs

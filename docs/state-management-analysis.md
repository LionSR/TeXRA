...
export const ResponseAssemblySchema = z
  .object({
...
function createInitializedSession(
  stream: StreamTabId,
): Initialized<StreamSessionState> {
...
function updateStreamHints(
  state: Initialized<StreamSessionState>,
  hints: StreamHints,
) {
...
const newAssembly = updateAssemblyState(workspace.assembly, {
  lastResponse: value,
});
```

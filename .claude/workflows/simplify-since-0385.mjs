...
const BATCHES = {
  ...
  'progressView-backend': [
    'src/shared/progressView/backend/persistence/StreamTabStore.ts',
    ...
    'src/shared/progressView/backend/ProgressBackend.ts',
    'src/shared/progressView/backend/WebviewBridge.ts',
    ...
    'src/shared/progressView/backend/state/ProgressViewState.ts',
    ...
    'src/shared/progressView/backend/WebviewUpdater.ts',

...
const BATCHES = [
  ...
  { name: 'progressView', files: [
    'src/shared/progressView/backend/persistence/StreamTabStore.ts', 'packages/extension/src/progressView/ProgressViewProvider.ts',
    'packages/extension/src/progressView/ProgressViewMessageHandler.ts', 'src/shared/progressView/backend/ProgressBackend.ts',
    'src/shared/progressView/backend/WebviewBridge.ts', 'src/controllers/progressView/ProgressViewApprovalCommandHandlers.ts',
    'src/shared/progressView/backend/events/ProgressEventHandler.ts', 'src/controllers/progressView/ProgressViewFollowUpCommandHandlers.ts',
    ...
    'src/shared/progressView/backend/state/ProgressViewState.ts', 'src/controllers/progressView/ProgressViewFileCommandHandlers.ts',
    'src/controllers/progressView/ProgressViewLifecycleCommandHandlers.ts', 'src/shared/progressView/backend/WebviewUpdater.ts',

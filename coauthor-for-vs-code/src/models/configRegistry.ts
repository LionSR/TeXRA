...
export interface OpenAICompatibleConfig extends ModelConfig {
    provider: ModelProvider.OPENAI | ModelProvider.OPENROUTER | ModelProvider.GOOGLE;
 ...
 */
function createAnthropicConfig(config: Partial<AnthropicModelConfig>): AnthropicModelConfig {
    return {
...
function createOpenAIConfig(config: Partial<OpenAIModelConfig>): OpenAIModelConfig {
    return {
        ...DEFAULT_MODEL_CONFIG,
        provider: ModelProvider.OPENAI,
        ...config
 ...
 */
export function getModelConfig<T extends ModelName>(modelName: T): ModelConfigRegistry[T] {
 ...
 */
export function getModelsByProvider<T extends ModelProvider>(provider: T): ModelConfig[] {

import{a as e,i as t,n,t as r}from"./chunk.W7QZX2CB.AYt45j_m.js";import{c as i,d as a,f as o,i as s,n as c,r as l,t as u}from"./chunk.AOKMSJXD.CwVty8ct.js";import{t as d}from"./chunk.PZAN6FPN.CukSyESI.js";import{t as f}from"./directive-helpers.BAHwZi2D.js";var p=class extends Event{constructor(){super(`wa-error`,{bubbles:!0,cancelable:!1,composed:!0})}},m=class extends Event{constructor(){super(`wa-load`,{bubbles:!0,cancelable:!1,composed:!0})}},h=a`
  :host {
  ...
  /* #endregion */
`,g=Symbol(),_=Symbol(),v,y=new Map,b=class extends u{constructor(){super(...arguments),this.svg=null,this.autoWidth=!1,this.swapOpacity=!1,this.label=``,this.library=`default`,this.rotate=0,this.resolveIcon=async(e,t)=>{let n;if(t?.spriteSheet){this.hasUpdated||await this.updateComplete,this.svg=i`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`,await this.updateComplete;let n=this.shadowRoot.querySelector(`[part='svg']`);return typeof t.mutator==`function`&&t.mutator(n,this),this.svg}try{if(n=await fetch(e,{mode:`cors`}),!n.ok)return n.status===410?g:_}catch{return _}try{let e=document.createElement(`div`);e.innerHTML=await n.text();let t=e.firstElementChild;if(t?.tagName?.toLowerCase()!==`svg`)return g;v||=new DOMParser;let r=v.parseFromString(t.outerHTML,`text/html`).body.querySelector(`svg`);return r?(r.part.add(`svg`),document.adoptNode(r)):g}catch{return g}}}connectedCallback(){super.connectedCallback(),e(this)}firstUpdated(e){super.firstUpdated(e),this.hasAttribute(`rotate`)&&this.style.setProperty(`--rotate-angle`,`${this.rotate}deg`),this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),t(this)}async getIconSource(){let e=n(this.library),t=this.family||r();if(this.name&&e){let n=this.canvas===`auto`||this.autoWidth,r;try{r=await e.resolver(this.name,t,this.variant,n)}catch{r=void 0}return{url:r,fromLibrary:!0}}return{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label==`string`&&this.label.length>0?(this.setAttribute(`role`,`img`),this.setAttribute(`aria-label`,this.label),this.removeAttribute(`aria-hidden`)):(this.removeAttribute(`role`),this.removeAttribute(`aria-label`),this.setAttribute(`aria-hidden`,`true`))}async setIcon(){let{url:e,fromLibrary:t}=await this.getIconSource(),r=t?n(this.library):void 0;if(!e){this.svg=null;return}let i=y.get(e);i||(i=this.resolveIcon(e,r),y.set(e,i));let a=await i;if(a===_&&y.delete(e),e===(await this.getIconSource()).url){if(f(a)){this.svg=a;return}switch(a){case _:case g:this.svg=null,this.dispatchEvent(new p);break;default:this.svg=a.cloneNode(!0),r?.mutator?.(this.svg,this),this.dispatchEvent(new m)}}}willUpdate(e){return this.style||this.setStyleProperty(`--rotate-angle`,`${this.rotate}deg`),super.willUpdate(e)}updated(e){super.updated(e);let t=n(this.library);this.hasAttribute(`rotate`)&&this.style.setProperty(`--rotate-angle`,`${this.rotate}deg`);let r=this.shadowRoot?.querySelector(`svg`);r&&t?.mutator?.(r,this)}render(){return this.hasUpdated?this.svg:i`<svg part="svg" width="16" height="16" viewBox="0 0 16 16"></svg>`}};b.css=h,o([c()],b.prototype,`svg`,2),o([l({reflect:!0})],b.prototype,`name`,2),o([l({reflect:!0})],b.prototype,`family`,2),o([l({reflect:!0})],b.prototype,`variant`,2),o([l({reflect:!0})],b.prototype,`canvas`,2),o([l({attribute:`auto-width`,type:Boolean,reflect:!0})],b.prototype,`autoWidth`,2),o([l({attribute:`swap-opacity`,type:Boolean,reflect:!0})],b.prototype,`swapOpacity`,2),o([l()],b.prototype,`src`,2),o([l()],b.prototype,`label`,2),o([l({reflect:!0})],b.prototype,`library`,2),o([l({type:Number,reflect:!0})],b.prototype,`rotate`,2),o([l({type:String,reflect:!0})],b.prototype,`flip`,2),o([l({type:String,reflect:!0})],b.prototype,`animation`,2),o([d(`label`)],b.prototype,`handleLabelChange`,1),o([d([`family`,`name`,`library`,`variant`,`src`,`autoWidth`,`canvas`,`swapOpacity`],{waitUntilFirstUpdate:!0})],b.prototype,`setIcon`,1),b=o([s(`wa-icon`)],b);export{b as t};
/**
 * The post-`initPlatform()` bootstrap, in one order for every host.
 *
 ...
 * ESLint pins the call to the roots. What follows that call was not
...
/**
 * Everything a TeXRA process installs once, after its platform exists.
 *

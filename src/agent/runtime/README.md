...
| **Run context & host interactions**   | Ambient per-run context and session-scoped host capabilities     | `RunContext` (`AsyncLocalStorage`-based ambient context), `HostInteractions` (session-owned host interaction port: diagnostics, manual criticism, unavailable-tool notices, plan approval, agent proposal, retry, bash, tool-edit, user question, external inquiry)                                                                                                                                                                                                                 |

...
| **Run registry & live handles**     | Track, interrupt, and tear down in-flight runs                   | `RunHandle` (the live handle type plus run-owned interrupt capability), `runRegistry` (registration, lookup, child lineage, interrupt and teardown), `detachSubagentsOnStop` (detach-vs-cascade policy)                                                                                                                                                                                                                                                                                                                                                                                                                                         |

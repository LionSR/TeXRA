...
| **Recovery & classification**         | Repair after a restart and classify what a run was               | `restartRepair` (session-scoped repair of runs orphaned by a host restart), `runClassification` (`classifyRun`, exported from the barrel), `streamApprovalQueue` (per-stream approval queueing), `workflowControlRegistry` (workflow-script grandchild skip/retry control)                                                                                                                                                                                                                                                                |

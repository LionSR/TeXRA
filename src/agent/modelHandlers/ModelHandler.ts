...
> implements IModelHandler<M, U, R>
{
  ...
  /**
   * Creates a helper for streaming reasoning/thinking text to the progress view.
   * @param groupId Optional log group ID
   * @returns An object with append and finalize methods
   */

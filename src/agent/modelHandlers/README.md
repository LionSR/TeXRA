...
| `support/`    | Cross-provider runtime collaborators (stream handling, media, proxy, usage and pricing math, SDK error adapters, `ServerChainState` — the server-side conversation-chain anchor shared by the OpenAI Responses and Google Interactions handlers)                                                                                                                                                                                                            |

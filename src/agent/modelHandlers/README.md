...
| `openai/`     | `modelHandlerOpenAI`, `modelHandlerOpenAIResponse`, Responses-API collaborators (`OpenAIResponseWebSocketTransport`, `ResponseStreamProcessor`, `responseStreamEvents`), OpenAI helpers (`openAIMessageUtils`, `openAIResponseErrors`, `BaseReasoningStreamAggregator`), and the OpenAI-**compatible** providers that extend `ModelHandlerOpenAI` (`modelHandlerDashScope/DeepSeek/GLM/Kimi/MiniMax/XAI`) |
| `google/`     | `modelHandlerGoogleGenAI`                                                                                                                                                                                                                                                            |

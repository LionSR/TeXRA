...
class VSCodeTransport extends Transport {
  ...
  // Method retained for backward compatibility; buffering handled by event bus
  replayBufferedMessages(): void {
    // No-op
  }

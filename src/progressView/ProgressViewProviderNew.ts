 ...
 */
export class ProgressViewProviderNew implements vscode.WebviewViewProvider {
  private static _instance: ProgressViewProviderNew | undefined;
  ...
  constructor(
    ...
    // Set instance
    ProgressViewProviderNew._instance = this;
  ...
  public static getInstance(): ProgressViewProviderNew | undefined {

...
// =============================================================================
// CSS Class Constants - Consolidates hardcoded class names used across modules
// =============================================================================
...
export const CSS_CLASSES = Object.freeze({
  ...
  BANNER_DETAILS_ERROR: 'banner-details--error',

  // Group classes
  GROUP_CONTENT: 'log-group-content',
  GROUP_HEADER: 'log-group-header',
  GROUP_STATUS_ICON: 'group-status-icon',
  GROUP_TITLE: 'group-title',
  GROUP_TIME: 'group-time',
  GROUP_DURATION: 'group-duration',
  GROUP_START_TIME: 'group-start-time',

  // Tool use classes
  TOOL_USE_ERROR: 'tool-use-error',
  TOOL_USE_TITLE: 'tool-use-title',
  ...
  ROUND_HEADER: 'round-header',

  // Copy button classes
  COPY_SUCCESS: 'copy-success',
  BANNER_CONTENT_COPY: 'banner-content-copy',

  // Status classes
  NATIVE_STATUS_LINE: 'native-status-line',
});

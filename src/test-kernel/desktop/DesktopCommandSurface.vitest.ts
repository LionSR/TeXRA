...
> = [
  ...
  ['texra.showModels', 'showSettings', ['models/models']],
  ['texra.showAgents', 'showSettings', ['agents/library']],
  ['texra.showTools', 'showSettings', ['tools/tools']],
  ['texra.showGitSettings', 'showSettings', ['general/git']],

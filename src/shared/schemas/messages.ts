 ...
 *
 * @module @shared/schemas/messages
 */
import { z } from 'zod';

import { APPROVAL_ACTIONS } from '../constants/approval';
...
export type PolishInstructionMessage = z.infer<typeof PolishInstructionMessageSchema>;
 ...
 */
export const FileSelectedMessageSchema = BaseMessageSchema.extend(WithFilePath.shape);
 ...
 */
export const RequestInputFileMessageSchema = BaseMessageSchema.extend(WithNotifyWhenEmpty.shape);

export type RequestInputFileMessage = z.infer<typeof RequestInputFileMessageSchema>;

/**
 * Request file message from webview
 */
export const RequestFileMessageSchema = BaseMessageSchema.extend(WithNotifyWhenEmpty.shape);
...
export type RequestEditedFileMessage = z.infer<typeof RequestEditedFileMessageSchema>;
...
export type RequestBaseFileMessage = z.infer<typeof RequestBaseFileMessageSchema>;
 ...
 */
export const SetMultipleFilesMessageSchema = BaseMessageSchema.extend(WithFiles.shape);

export type SetMultipleFilesMessage = z.infer<typeof SetMultipleFilesMessageSchema>;
...
export type SelectMultipleFilesMessage = z.infer<typeof SelectMultipleFilesMessageSchema>;
 ...
 */
export const UpdateFilesMessageSchema = BaseMessageSchema.extend(WithFiles.shape);
...
export type SetAllSingleFilesMessage = z.infer<typeof SetAllSingleFilesMessageSchema>;
...
export type SetApiAccessModeMessage = z.infer<typeof SetApiAccessModeMessageSchema>;

 ...
 * This file is shared between extension host and webview code.
 *
 * @module @shared/constants/commands
 */
...
// Type helpers for command strings
...
export type ProgressViewCommand =
  (typeof PROGRESS_VIEW_COMMANDS)[keyof typeof PROGRESS_VIEW_COMMANDS];
export type HistoryViewCommand =
  (typeof HISTORY_VIEW_COMMANDS)[keyof typeof HISTORY_VIEW_COMMANDS];
export type ProfileViewCommand =
  (typeof PROFILE_VIEW_COMMANDS)[keyof typeof PROFILE_VIEW_COMMANDS];

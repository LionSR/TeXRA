 ...
 * falls back to the input preview while it is still in flight. The `executions`
 * subagent labels are folded here at projection time, so a host never
 * re-derives the preview at paint time.
 */

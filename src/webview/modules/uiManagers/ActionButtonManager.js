...
/**
 * Handles action buttons like execute, merge and LaTeX diff.
 */
export class ActionButtonManager {
  constructor(vscodeApi = vscode, list = fileList) {
    this.vscode = vscodeApi;
    this.fileList = list;
  }

  setup(instructionManager, state) {
    this.instructionManager = instructionManager;
    this.state = state;
    this._setupEraseInstructionButton();
    this._setupMagicPolishButton();
    this._setupExecuteButton();
    this._setupMergeButton();
    this._setupPackCleanButtons();
    this._setupLatexdiffButtons();
    this._setupCompareAcceptButtons();
  }

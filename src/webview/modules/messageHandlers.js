...
export class MainViewMessageHandler extends BaseWebviewMessageHandler {
    ...
    try {
      ...
      if (workflowContext && (mode === 'workflow' || mode === 'chat')) {
        ...
        if (contextLine) {
          ...
          fullInstruction = contextLine + (fullInstruction ? '\n\n' + fullInstruction : '');
        }
      }
   ...
   * @param {Object} workflowContext - Context from previous workflow
   * @returns {string} The context line, or empty string if no valid context
   */
